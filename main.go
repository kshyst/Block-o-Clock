...
type Block struct {
	Index     int32  // is the position of the data record in the blockchain
	Timestamp string // is automatically determined and is the time the data is written
	BPM       int32  // or beats per minute, is your pulse rate
...
func generateBlock(oldBlock Block, BPM int32) (Block, error) {
